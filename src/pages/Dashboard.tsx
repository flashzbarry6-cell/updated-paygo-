      ...
      <div className="w-full max-w-md bg-gray-50">
        ...
        <div className="bg-white p-4 flex justify-center">
          <img 
            ...
            alt="PayGo Logo" 
            className="h-16 w-auto animate-[slide-in-right_0.5s_ease-in-out_infinite_alternate]"
          />
        </div>
        ...
        <div className="flex-1 px-4 py-6">
          ...
          <div className="mt-8">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Current Promotions</h3>
            <PromotionalCarousel />
          </div>
        </div>
