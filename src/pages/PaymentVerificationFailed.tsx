        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center bg-gray-50 min-h-screen">
          ...
          <div className="space-y-3 w-full">
            <Button 
              ...
              className="w-full bg-gradient-to-r from-[#9b20f5] to-[#ff6f43] hover:opacity-90 text-white text-lg py-4 rounded-full"
            >
              Try Again
            </Button>
            ...
            <Button 
              ...
              variant="outline"
              className="w-full text-lg py-4 rounded-full border-gray-300 text-gray-700 hover:bg-gray-50"
            >
              Go to Dashboard
            </Button>
          </div>
