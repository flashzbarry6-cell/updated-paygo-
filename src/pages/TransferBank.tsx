...
const TransferBank = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="bg-[#9b87f5] p-5 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <Input 
              ...
              className="border-2 border-[#9b87f5]/30 rounded-xl h-14 text-lg"
            />
          </div>
          ...
          <div>
            <Select value={bank} onValueChange={setBank}>
              <SelectTrigger className="border-2 border-[#9b87f5]/30 rounded-xl h-14 text-lg">
