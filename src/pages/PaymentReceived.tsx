    ...
    <div className="flex justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-sm bg-white min-h-screen">
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-3">Payment Received</h2>
          ...
          <div className="bg-gray-50 p-4 rounded-lg mb-6 w-full">
            <p className="text-base font-bold text-center mb-3">{payId}</p>
            <Button 
          ...
          <Button 
            ...
            className="w-full bg-[#442f94] hover:bg-[#372875] text-white text-base py-4 rounded-lg"
          >
            Return to Dashboard
          </Button>
        </div>
